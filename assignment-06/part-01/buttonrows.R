...
buttonRow7 <- function(inputIds, labels, btnStyle) {
  fluidRow(
    column(1,offset = 1,
           actionButton(inputId = inputIds[1], label =  labels[1],style=btnStyle)),
    column(1,offset = 1,
    ...
    column(2,offset = 1,
           actionButton(inputId = inputIds[5], label =  labels[5],style=btnStyle)),
    column(2,offset = 1,
           actionButton(inputId = inputIds[6], label =  labels[6],style=btnStyle)),
    column(2,offset = 1,
           actionButton(inputId = inputIds[7], label =  labels[7],style=btnStyle))
  ) #row
}
